<div class="nav">
        ...
        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
            <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="{{ url('dashboard/kategori') }}">Mata Pelajaran</a>
                <a class="nav-link" href="{{ url ('dashboard/databuku')}}">Buku</a>
            </nav>
        </div>
        ...
        <div class="sb-sidenav-menu-heading">Single</div>
